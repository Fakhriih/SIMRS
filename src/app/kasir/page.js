...
export default function KasirPlaceholderPage() {
  return (
        ...
        <div className="bg-white rounded-2xl p-8 border border-slate-200/80 shadow-xs space-y-6">
          <div>
            ...
            <p className="text-sm text-slate-600 mt-2 leading-relaxed">
              Selamat datang di Modul Kasir. Halaman ini masih kosong (placeholder) dan sedang dikerjakan oleh anggota tim lain.
            </p>
          </div>
